...
@WebServlet(name = "FileUploadServlet3", urlPatterns = "/fileupload3.do")
// 使用注解@MultipartConfig将一个Servlet标识为支持文件上传
@MultipartConfig
public class FileUploadServlet3 extends BaseServlet {

	public void doFileUploadOne(HttpServletRequest request, HttpServletResponse response)
	...
	public void doFileUploadMany(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
