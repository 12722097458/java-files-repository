...
public class JSONUtils {
    ...
    public static void writeEasyUIJSON(PageUtils pageUtils, HttpServletResponse response) throws IOException {

        Map<String, Object> easyUIResult=new HashMap<String, Object>();

        easyUIResult.put("total", pageUtils.getTotalCount());
        easyUIResult.put("rows", pageUtils.getData());

        JSON.DEFFAULT_DATE_FORMAT="yyyy-MM-dd HH:mm:ss";
        String jsonString = JSONObject.toJSONString(easyUIResult, SerializerFeature.WriteDateUseDateFormat);
    ...
    public static void writeData2Map(Object data) {
